...
namespace Pokemon_Compilator
{
    public partial class Helper : Form
    {
        ...
        {
            InitializeComponent();
            this.textBox1.Text = @"Poki Compiler, part by SylverWolf DW
...
7. Zmienne przy pokedex:
    ...
    * pokedex input show - pokazanie okna do wpisywania tekstu
    * pokedex input hide - ukrycie okna
    * pokedex input save var - zapisanie wartości z okienka do zmiennej nowej
